...
def ejecutar_prediccion(username: str = "sistema") -> bool:
    """Ejecuta predicción en tiempo real usando el modelo entrenado."""
    ...
    log_event(username, "predict_start")
    ...
    try:
        ...
        log_event(username, "predict_finish")
        return True
    finally:
        cap.release()
